...
import adBannerRoutes from "./routes/adBanners.js";
...
app.get("/api/uploads/:id", async (req, res) => {
  try {
    ...
    // Required for any browser-side canvas pixel access on this image (OCR,
    // image processing) — without it, the canvas is "tainted" and blocked
    // from reading pixel data even though the image itself displays fine.
