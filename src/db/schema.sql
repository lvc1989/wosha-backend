...
CREATE TABLE IF NOT EXISTS business_settings (
  ...
  login_background_color TEXT DEFAULT '#F5F7FA',  -- customizable login page background
...
ALTER TABLE business_settings ADD COLUMN IF NOT EXISTS login_background_color TEXT DEFAULT '#F5F7FA';
...
INSERT INTO categories (type, name) VALUES
  ...
  ('cashflow','Sales'), ('cashflow','Supplier Payment'), ('cashflow','Payroll'), ('cashflow','Other')
