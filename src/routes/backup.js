...
router.get("/export", requireAuth, requirePrimaryOwner, async (req, res) => {
...
router.post("/restore", requireAuth, requirePrimaryOwner, async (req, res) => {
...
router.post("/quick-point", requireAuth, requirePrimaryOwner, async (req, res) => {
  const dump = await dumpAllTables();
  await pool.query(
...
router.get("/quick-point", requireAuth, requirePrimaryOwner, async (req, res) => {
...
router.post("/quick-point/restore", requireAuth, requirePrimaryOwner, async (req, res) => {
